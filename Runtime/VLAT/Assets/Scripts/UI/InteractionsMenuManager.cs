...
namespace VLAT
{
    public class InteractionsMenuManager : MonoBehaviour
    {
        ...
        // Returns whether an object is currently highlighted by selection controller
        //--------------------------------------//
        public bool ObjectIsHighlighted()
        //--------------------------------------//
        {
            if (selectionController.currentObj != null)
                return true;
        ...
        //--------------------------------------//
        {
            if (selectionController.currentObj != null && selectionController.currentObj.interactions.Count > 0)
            {
                return true;
            }
            else
