...
namespace VLAT
{
    public class VLAT_MenuNavigator : MonoBehaviour
    {
        ...
        [Tooltip("Whether the VLAT accessibility menu should be automatically hidden when the user begins navigation of this menu")]
        ...
        [Tooltip("Whether the user should be allowed to manually exit navigation of this menu (e.g., with the VLAT back button)")]
        public bool allowUserToExit = false;

        [Tooltip("Called when the currently highlighted menu item is changed (e.g., user goes to next/previous item)")]
        public UnityEvent onChangeHighlightedItem;
        [Tooltip("Called when the user presses the \"Back\" button (which should usually stop navigation of a menu)")]
        public UnityEvent onUserBackButton;
        ...
        //--------------------------------------//
        {
            if (menuNavigation == null)
                ...
                menuNavigation = FindAnyObjectByType<NewMenuNavigation>();
#else
        ...
        //--------------------------------------//
        public void StopMenuNavigation(bool showVlatMenuOnStop)
        //--------------------------------------//
        {
            if (menuNavigation == null)
            {
            ...
            menuNavigation.StopNavigateExternalMenu(showVlatMenuOnStop);
