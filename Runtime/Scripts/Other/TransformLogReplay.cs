...
namespace VERA
{
    internal class TransformLogReplay : MonoBehaviour
    {
    ...
    dataPath = Path.Combine(Application.persistentDataPath);
            ...
            if (csvFile == null)
            {
                // Find the most recently modified CSV file in the dataPath directory
                ...
                else
                {
                    ...
                    csvFile = new TextAsset(File.ReadAllText(files[0]));
